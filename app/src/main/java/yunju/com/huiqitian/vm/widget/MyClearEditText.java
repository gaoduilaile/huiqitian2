 ...
 */
public class MyClearEditText extends EditText implements View.OnFocusChangeListener, TextWatcher, View.OnClickListener {
    ...
    private void setDrawable(Context context) {
        ...
        if (mClearDrawable == null) {
            //获取默认图标
            mClearDrawable = getResources().getDrawable(R.mipmap.pet_name_del);
        }
        mClearDrawable.setBounds(0, 0, dip2px(context, 20), dip2px(context, 20));
        //左边图标
        mLeftDrawable = getCompoundDrawables()[DRAWABLE_LEFT];
        if (mLeftDrawable != null) {
            mLeftDrawable.setBounds(0, 0, dip2px(context, 20), dip2px(context, 20));
        }
    }
